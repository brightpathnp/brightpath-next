      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-blue-50 text-base md:text-xl max-w-3xl mx-auto font-medium leading-relaxed opacity-90">
            From first consultation to global placement, we provide a structured pathway for every
            student aspiring for world-class education.
          </p>
        </div>
      </section>
            ...
            {SERVICES.map((service: Service) => {
              ...
              return (
                <Link
                  ...
                  className="group bg-slate-50 rounded-[2rem] p-10 border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 transition-all duration-500 flex flex-col relative overflow-hidden"
                >
                  {/* Icon — flips to solid brand-blue bg + white icon on hover */}
                  <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-8 text-brand-blue group-hover:bg-brand-blue group-hover:text-white transition-all duration-300 shadow-sm shrink-0">
                  ...
                  <p className="text-slate-500 mb-8 flex-1 leading-relaxed font-light line-clamp-3">
                  ...
                  {service.points && (
                    <div className="space-y-3 mb-10">
                      {service.points.slice(0, 3).map((p, idx) => (
                        <div
                          key={idx}
                          className="flex items-center gap-3 text-xs text-slate-600 font-bold uppercase tracking-wide"
                        >
                  ...
                  {/* "Read More" fades in on hover — same as homepage cards */}
                  <div className="mt-2 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-brand-blue opacity-0 group-hover:opacity-100 transition-all duration-300">
                    Read More <ArrowRight className="w-3.5 h-3.5 group-hover:translate-x-1 transition-transform" aria-hidden="true" />
                  </div>
                </Link>
              );
            })}
          ...
          <div className="bg-[#0f172a] rounded-[4rem] p-16 md:p-24 text-center shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <button
                ...
                className="px-14 py-5 bg-brand-blue text-white rounded-2xl font-black text-[14px] uppercase tracking-[0.2em] shadow-2xl shadow-blue-500/20 hover:scale-105 active:scale-95 transition-all"
              >
