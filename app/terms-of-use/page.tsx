...
const termsSections: TermsSection[] = [
    {
        ...
        content: [
            'By accessing or using the BrightPath Nepal Education website (www.brightpathnepal.com) and any services offered through it, you agree to be bound by these Terms of Use, our Privacy Policy, and all applicable laws and regulations.',
    ...
    },
    {
        ...
        content: [
            'All content on this website — including text, graphics, logos, images, audio clips, downloadable files, and software — is the property of BrightPath Nepal Education or its content suppliers and is protected by applicable intellectual property laws.',
            'You may not reproduce, distribute, modify, transmit, reuse, or republish any content from this website for public or commercial purposes without prior written permission from BrightPath Nepal Education.',
        ],
    },
    {
    ...
    },
    {
        ...
        content: [
            'If you have any questions, concerns, or requests regarding these Terms of Use, please contact us at info@brightpathnepal.com or visit our office in Kathmandu, Nepal.',
        ],
    },
];
                ...
                <div className="mx-auto max-w-4xl">
                    <div className="mb-12 rounded-2xl border border-slate-200 bg-slate-50 p-8">
                        <p className="text-base leading-relaxed text-slate-600">
                            These Terms of Use govern your access to and use of the BrightPath Nepal Education website (www.brightpathnepal.com) and the services we provide. By using our website or engaging with our consultancy services, you confirm that you have read, understood, and agree to be bound by these terms.
                        </p>
                    </div>
